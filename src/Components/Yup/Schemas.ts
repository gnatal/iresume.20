...
export const LinkInfoSchema = (t) => {
  return yup.object().shape({
    label: yup.string().typeError(t("yupSomethingWrongMsg")).required(t("yupSkillMsg")).max(30, t("yupSomethingWrongMsg")),
    url: yup.string().typeError(t("yupSomethingWrongMsg")).required(t("yupSkillMsg")).max(200, t("yupSomethingWrongMsg")),
